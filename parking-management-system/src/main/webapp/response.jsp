...
<body>
	<nav class="navbar navbar-expand-sm bg-dark"
		...
		<a href="Adminpage.jsp"><button type="button"
				class="btn btn-primary button">Home</button></a> <a href="loginpage.jsp"><button
	...
	<div align="center">
		...
		Location:${dtos.Location}<br> Vehicle Type:${dtos.VechicalType}<br>
		Vehicle Classification :${dtos.VechicalClassification}<br>
		Terms:${dtos.terms}<br> Price:${dtos.price}<br>
