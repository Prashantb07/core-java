    ...
    <nav class="navbar navbar-expand-sm bg-dark" style="background-color: black;">
        <div class="but">
            ...
            <div class="buttons">
                ...
                <a href="loginpage.jsp"><button type="button" class="btn btn-primary button">LogOut</button></a>
            </div>
        </div>
    </nav>
    ...
    <table class="table table-border">
        ...
        <c:forEach items="${list}" var="dto">
            <tr>
                ...
                <td>${dto.Location}</td>
                <td>${dto.VechicalType}</td>
                <td>${dto.VechicalClassification}</td>
                <td>${dto.terms}</td>
                <td>${dto.price}</td>
                <th>${dto.discount}</th>
