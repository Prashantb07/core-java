...
public class Inseration {
	...
	public static void main(String[] args) {
		...
		try {
			...
			statement.setInt(1,satishDTO .getId());
			statement.setString(2, satishDTO .getQualification());
			statement.setString(3, satishDTO .getPlace());
			statement.setLong(4, satishDTO .getMobileNo());
